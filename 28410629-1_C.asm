...
section .data
	msg	db	"Result : %i", 0x0a, 0x00	; creates a variable containing string message and integer holder
	result	dd	0	
section .text
...
main:
	...
	mov	[result], dword 0	; uses general registery ecx to store result, gives initial value
mult:	
	add	[result], dword eax	; add value of eax to ecx
	...
	push 	dword [result]		; result is pushed first on to stack, due to LIFO
